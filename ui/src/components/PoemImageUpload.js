...
class PoemImageUpload extends React.Component {
	constructor(props) {
		super(props);
	...
	fileUploadInputChange = (e) => {
		if (e.target.files.length > 0) this.props.handleImageUpload(e.target.files[0]);
	};
	...
	render() {
		return (
			<div
				...
				style={{ marginTop: '50px', marginBottom: '50px', display: 'flex', justifyContent: 'center' }}
			>
				...
				>
					<img className="poem-image-background" src={this.props.imageURL} />
					<div className="poem-image-edit">
						<div className="profile-edit-svg">
							<svg class="svgIcon-use" width="65" height="65" onClick={this.fileUploadAction}>
								<g fill-rule="evenodd">
...
export default PoemImageUpload;
