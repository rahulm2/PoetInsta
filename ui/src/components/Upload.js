...
class Upload extends React.Component {
	...
	fileUploadInputChange = (e) => {
		...
		uploadImageData.append('imageFile', e.target.files[0]);
		this.props.updateUserImage(uploadImageData);
	};
	...
	render() {
		return (
			<div className="profile-image">
				...
				<div class="profile-image-background-container">
					<img
						className="profile-image-background"
						onClick={this.fileUploadAction}
						src={this.props.imageURL ? 'data:image/jpeg;base64,' + this.props.imageURL : upload}
					/>
					<div className="profile-image-edit">
						<div className="profile-edit-svg">
							<svg class="svgIcon-use" width="65" height="65">
								<g fill-rule="evenodd">
...
export default connect(null, { updateUserImage })(Upload);
